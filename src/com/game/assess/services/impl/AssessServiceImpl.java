...
public class AssessServiceImpl extends GenericServiceImpl<Assess, Long>
	...
	public List<Object[]> getAssessByPassive(Long userID, Integer type,
		...
		if (span != null && span.equals(7)) {
			hql = "select count(*),a.grade from Assess a where a.type= "
					+ type
					+ " and a.passive.id = "
					+ userID
	...
	public CreditCount findCountByTime(Long userID) throws Exception {
		...
		String weektime = DateUtil.nowDate(Constant.YYYY_MM_DD_HH_MM_SS,
				DateUtil.Ds(-7));
		String monthtime = DateUtil.nowDate(Constant.YYYY_MM_DD_HH_MM_SS,
				DateUtil.MonthAdd(-1));
		String yeartime = DateUtil.nowDate(Constant.YYYY_MM_DD_HH_MM_SS,
				DateUtil.MonthAdd(-6));
		...
		String hql = null;
		// 卖家总计好评数
		hql = "select count(*) from Assess a where a.type=1 and a.passive.id="
				+ userID + " and grade=1";
		assess_under = new AssessUnder(hql, "sellerAllHP", creditCount,
				runningThreads);
		...
		hql = "select count(*) from Assess a where a.type=1 and a.passive.id="
				+ userID + " and grade=0";
		assess_under = new AssessUnder(hql, "sellerAllZP", creditCount,
				runningThreads);
		t1 = new Thread(assess_under);
		t1.start();
		// 卖家总计差评数
		hql = "select count(*) from Assess a where a.type=1 and a.passive.id="
				+ userID + " and grade=-1";
		assess_under = new AssessUnder(hql, "sellerAllCP", creditCount,
				runningThreads);
		t1 = new Thread(assess_under);
		t1.start();

		// 买家总计好评数
		hql = "select count(*) from Assess a where a.type=0 and a.passive.id="
				+ userID + " and grade=1";
		assess_under = new AssessUnder(hql, "buyerAllHP", creditCount,
				runningThreads);
		t1 = new Thread(assess_under);
		t1.start();
		// 买家总计中评数
		hql = "select count(*) from Assess a where a.type=0 and a.passive.id="
				+ userID + " and grade=0";
		assess_under = new AssessUnder(hql, "buyerAllZP", creditCount,
				runningThreads);
		t1 = new Thread(assess_under);
		t1.start();
		// 买家总计差评数
		hql = "select count(*) from Assess a where a.type=0 and a.passive.id="
				+ userID + " and grade=-1";
		assess_under = new AssessUnder(hql, "buyerAllCP", creditCount,
				runningThreads);
		t1 = new Thread(assess_under);
		t1.start();
		...
		// 卖家最近一周好评数
		hql = "select count(*) from Assess a where a.type=1 and a.passive.id="
				+ userID + " and grade=1 and time>'" + weektime
				+ "' and time<'" + nowtime + "'";
		assess_under = new AssessUnder(hql, "sellerWeekHP", creditCount,
				runningThreads);
		t1 = new Thread(assess_under);
		t1.start();
		// 卖家最近一周中评数
		hql = "select count(*) from Assess a where a.type=1 and a.passive.id="
				+ userID + " and grade=0 and time>'" + weektime
				+ "' and time<'" + nowtime + "'";
		assess_under = new AssessUnder(hql, "sellerWeekZP", creditCount,
				runningThreads);
		t1 = new Thread(assess_under);
		t1.start();
		// 卖家最近一周差评数
		hql = "select count(*) from Assess a where a.type=1 and a.passive.id="
				+ userID + " and grade=-1 and time>'" + weektime
				+ "' and time<'" + nowtime + "'";
		assess_under = new AssessUnder(hql, "sellerWeekCP", creditCount,
				runningThreads);
		t1 = new Thread(assess_under);
		t1.start();
		...
		hql = "select count(*) from Assess a where a.type=0 and a.passive.id="
				+ userID + " and grade=1 and time>'" + weektime
				+ "' and time<'" + nowtime + "'";
		assess_under = new AssessUnder(hql, "buyerWeekHP", creditCount,
				runningThreads);
		t1 = new Thread(assess_under);
		t1.start();
		// 买家最近一周中评数
		hql = "select count(*) from Assess a where a.type=0 and a.passive.id="
				+ userID + " and grade=0 and time>'" + weektime
				+ "' and time<'" + nowtime + "'";
		assess_under = new AssessUnder(hql, "buyerWeekZP", creditCount,
				runningThreads);
		t1 = new Thread(assess_under);
		t1.start();
		// 买家最近一周差评数
		hql = "select count(*) from Assess a where a.type=0 and a.passive.id="
				+ userID + " and grade=-1 and time>'" + weektime
				+ "' and time<'" + nowtime + "'";
		assess_under = new AssessUnder(hql, "buyerWeekCP", creditCount,
				runningThreads);
		t1 = new Thread(assess_under);
		t1.start();
		...
		// 卖家最近一月好评数
		hql = "select count(*) from Assess a where a.type=1 and a.passive.id="
				+ userID + " and grade=1 and time>'" + monthtime
				+ "' and time<'" + nowtime + "'";
		assess_under = new AssessUnder(hql, "sellerMonthHP", creditCount,
				runningThreads);
		t1 = new Thread(assess_under);
		t1.start();
		// 卖家最近一月中评数
		hql = "select count(*) from Assess a where a.type=1 and a.passive.id="
				+ userID + " and grade=0 and time>'" + monthtime
				+ "' and time<'" + nowtime + "'";
		assess_under = new AssessUnder(hql, "sellerMonthZP", creditCount,
				runningThreads);
		t1 = new Thread(assess_under);
		t1.start();
		// 卖家最近一月差评数
		hql = "select count(*) from Assess a where a.type=1 and a.passive.id="
				+ userID + " and grade=-1 and time>'" + monthtime
				+ "' and time<'" + nowtime + "'";
		assess_under = new AssessUnder(hql, "sellerMonthCP", creditCount,
				runningThreads);
		t1 = new Thread(assess_under);
		t1.start();
		...
		hql = "select count(*) from Assess a where a.type=0 and a.passive.id="
				+ userID + " and grade=1 and time>'" + monthtime
				+ "' and time<'" + nowtime + "'";
		assess_under = new AssessUnder(hql, "buyerMonthHP", creditCount,
				runningThreads);
		t1 = new Thread(assess_under);
		t1.start();
		// 买家最近一月中评数
		hql = "select count(*) from Assess a where a.type=0 and a.passive.id="
				+ userID + " and grade=0 and time>'" + monthtime
				+ "' and time<'" + nowtime + "'";
		assess_under = new AssessUnder(hql, "buyerMonthZP", creditCount,
				runningThreads);
		t1 = new Thread(assess_under);
		t1.start();
		// 买家最近一月差评数
		hql = "select count(*) from Assess a where a.type=0 and a.passive.id="
				+ userID + " and grade=-1 and time>'" + monthtime
				+ "' and time<'" + nowtime + "'";
		assess_under = new AssessUnder(hql, "buyerMonthCP", creditCount,
				runningThreads);
		t1 = new Thread(assess_under);
		t1.start();
		...
		// 卖家最近六个月好评数
		hql = "select count(*) from Assess a where a.type=1 and a.passive.id="
				+ userID + " and grade=1 and time>'" + yeartime
				+ "' and time<'" + nowtime + "'";
		assess_under = new AssessUnder(hql, "sellerYearHP", creditCount,
				runningThreads);
		t1 = new Thread(assess_under);
		t1.start();
		// 卖家最近六个月中评数
		hql = "select count(*) from Assess a where a.type=1 and a.passive.id="
				+ userID + " and grade=0 and time>'" + yeartime
				+ "' and time<'" + nowtime + "'";
		assess_under = new AssessUnder(hql, "sellerYearZP", creditCount,
				runningThreads);
		t1 = new Thread(assess_under);
		t1.start();
		// 卖家最近六个月差评数
		hql = "select count(*) from Assess a where a.type=1 and a.passive.id="
				+ userID + " and grade=-1 and time>'" + yeartime
				+ "' and time<'" + nowtime + "'";
		assess_under = new AssessUnder(hql, "sellerYearCP", creditCount,
				runningThreads);
		t1 = new Thread(assess_under);
		t1.start();
		...
		hql = "select count(*) from Assess a where a.type=0 and a.passive.id="
				+ userID + " and grade=1 and time>'" + yeartime
				+ "' and time<'" + nowtime + "'";
		assess_under = new AssessUnder(hql, "buyerYearHP", creditCount,
				runningThreads);
		t1 = new Thread(assess_under);
		t1.start();
		// 买家最近六个月中评数
		hql = "select count(*) from Assess a where a.type=0 and a.passive.id="
				+ userID + " and grade=0 and time>'" + yeartime
				+ "' and time<'" + nowtime + "'";
		assess_under = new AssessUnder(hql, "buyerYearZP", creditCount,
				runningThreads);
		t1 = new Thread(assess_under);
		t1.start();
		// 买家最近六个月差评数
		hql = "select count(*) from Assess a where a.type=0 and a.passive.id="
				+ userID + " and grade=-1 and time>'" + yeartime
				+ "' and time<'" + nowtime + "'";
		assess_under = new AssessUnder(hql, "buyerYearCP", creditCount,
				runningThreads);
		t1 = new Thread(assess_under);
		t1.start();
	...
	class AssessUnder implements Runnable {
		...
		public AssessUnder(String hql, String model, CreditCount creditCount,
				List<Runnable> runningThreads) {
			this.hql = hql;
			this.model = model;
		...
		public void run() {
			try {
				...
				count = Integer
						.valueOf(baseDAO.findList(hql).get(0).toString());
