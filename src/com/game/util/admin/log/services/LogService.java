...
public interface LogService extends GenericService<Log, Long> {
	 ...
	 * @throws Exception
	 */
	Page<Log> getAllManage(int size, int goPage, Log filterLog)
			throws Exception;
	 ...
	 * 
	 * @param domain
	 *            实体，由org.apache.commons.lang.builder.
	 *            ToStringBuilder解析实体内容并拼接成日志内容
	 * @param remark
	 *            备注
	 * @param type
	 *            类型 com.game.util.domain.Log 里含有4中类型
	 * @see public static final int INFO = 1; //信息 public static final int WARN
	 *      = 2; //警告 public static final int ERROR = 3; //错误 public static
	 *      final int FATAL = 4; //灾难性异常
	 * @throws Exception
	 */
