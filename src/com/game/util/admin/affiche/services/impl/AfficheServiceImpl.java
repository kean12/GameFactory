...
public class AfficheServiceImpl extends GenericServiceImpl<Affiche, Long>
	...
	public List<Affiche> findAfficheByCount(Integer type, Integer state,
		...
		String hql = "from Affiche a where" + " a.type=" + type + " and"
				+ " a.state=" + state + " order by a.time desc";
