...
public class CreditServiceImpl extends GenericServiceImpl<Credit, Long>
		implements CreditService {

	public List<Credit> findCredit(Integer type, Integer grade)
			throws Exception {
	...
	public Credit findCreditByGrade(Integer type, Integer grade)
			throws Exception {
	...
	public List<Credit> findCreditGTGrade(Integer type, Integer grade)
			throws Exception {
		String hql = "from Credit a where 1=1";
		if (type != null) {
			hql += " and a.type=" + type;
	...
	public void updateCreditByMaxGrade(Integer maxCredit, Integer type)
			throws Exception {
		int grade = 0;
		List<Object> list = baseDAO
				.findList("select Max(a.grade) from Credit a where a.type="
						+ type);
		Object obj = list.get(0);
		if (obj != null) {
			grade = Integer.valueOf(obj.toString());
		}
		String hql = "update Credit a set a.upper=" + maxCredit
