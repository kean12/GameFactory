...
public class UserRoleServiceImpl extends GenericServiceImpl<UserRole, Long>
	...
	public List<UserRole> findUserRoleByUser(Long userID) throws Exception {
		return baseDAO.findEntity(
				"from UserRole a where a.user.id=? order by id", userID);
	}

	public UserRole getUserRole(Long userID, String roleName) throws Exception {
		String hql = "from UserRole a where a.user.id=" + userID
				+ " and a.roleName=?";
